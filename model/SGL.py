...
class SGL(GraphRecommender):
    ...
    def train(self):
        ...
        for epoch in range(self.maxEpoch):
            dropped_adj1 = self.graph_reconstruction()
            dropped_adj2 = self.graph_reconstruction()
            for n, batch in enumerate(next_batch_pairwise(self.data, self.batch_size)):
                ...
                cl_loss = self.cl_rate * self.cal_cl_loss([user_idx, pos_idx], dropped_adj1, dropped_adj2)
    ...
    def cal_cl_loss(self, idx, perturbed_mat1, perturbed_mat2):
        ...
        user_view_1, item_view_1 = self.model(perturbed_mat1)
        user_view_2, item_view_2 = self.model(perturbed_mat2)
